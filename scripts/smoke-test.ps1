...
Assert-Contains "operator to primary person autofill" 'function syncPrimaryPersonFromOperator()'
Assert-Contains "primary person name autofill" 'nameInput.value = operatorName'
Assert-Contains "primary person phone autofill" 'phoneInput.value = operatorPhone'
