...
Assert-Contains "conditional people prompt" 'function shouldPromptForPeople'
Assert-Contains "step availability" 'function stepAvailable(index)'
Assert-Contains "next available step" 'function nextAvailableStep(index)'
Assert-Contains "previous available step" 'function previousAvailableStep(index)'
